...
if(isset($_POST['submit'])){
   ...
   // $enccpass = password_hash($cpass, PASSWORD_BCRYPT);
    ...
    $usernamequery = "SELECT * FROM USERSIGNUP WHERE U_USERNAME= '$uname'";
    $uquery = mysqli_query($conn, $usernamequery);
    $usercount = mysqli_num_rows($uquery);


    $emailquery = "SELECT * FROM USERSIGNUP WHERE U_EMAIL= '$email'";
    ...
    else
    {
      if($pass === $cpass)
      {
        $insertquery = "INSERT INTO USERSIGNUP (USER_NAME, U_EMAIL, U_USERNAME, U_PASSWORD, C_U_PASSWORD) VALUES ('$fname','$email','$uname','$pass','$cpass')";
            ...
            <div class="container">
                <div class="signup-content">
                    ...
                    <div class="signup-image">
                        ...
                        <a href="UserLogin.php" class="signup-image-link">I am already member</a>
                    </div>
                </div>
            </div>
        </section>
