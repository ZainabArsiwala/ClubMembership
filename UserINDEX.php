...
//-------------------------------------------//
//To connect with Feedback Table
if(isset($_POST['submit'])){

  //User fields
  $f_name = mysqli_real_escape_string($conn, $_POST['feedback_name']); 
  $f_email = mysqli_real_escape_string($conn, $_POST['feedback_email']);
  $f_subject = mysqli_real_escape_string($conn, $_POST['feedback_subject']);
  $f_message = mysqli_real_escape_string($conn, $_POST['feedback_message']);


//insertion
$insertquery = "INSERT INTO FEEDBACK (F_NAME,EMAIL, SUBJECT, MESSAGE) VALUES ('$f_name','$f_email','$f_subject','$f_message')";
...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="UserINDEX.php">UNWIND<span>.</span></a></h1>
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li><a href="EnrollUser.php">Enroll</a></li>
          <li><a href="UserLogout.php">Logout</a></li>

        </ul>
      </nav><!-- .nav-menu -->

      <a href="UserINDEX.php" class="get-started-btn scrollto"><?php echo "HI, ".$_SESSION['uname'];?></a>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
              ...
              <h4><a href="yogaUser.php">Yoga</a></h4>
    ...
    <section id="cta" class="cta">
      <div class="container" data-aos="zoom-in">
        ...
        <div class="text-center">
          ...
          <a class="cta-btn" href="EnrollUser.php">Enroll</a>
        </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                <h4>Yoga</h4>
                <div class="portfolio-links">
                  <a href="yogaUser.php" title="More Details"><i class="bx bx-link"></i></a>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="owl-carousel testimonials-carousel">
        ...
        <div class="testimonial-item">
          ...
          <p>
            ...
            It has been awesome to me. Their trainers are exceptional, the overall vibe is great and I have had nothing but good experiences. I definitely recommend them to my friends and family.
        ...
        <div class="testimonial-item">
          ...
          <p>
            <i class="bx bxs-quote-alt-left quote-icon-left"></i>
            Hands down, best choice I’ve made training at UNWIND. VERY friendly team who make me actually want to go train. I look forward to walking through the doors and always feel amazing when I leave.
            <i class="bx bxs-quote-alt-right quote-icon-right"></i>
          </p>
        </div>
        ...
        <div class="testimonial-item">
          ...
          <p>
            <i class="bx bxs-quote-alt-left quote-icon-left"></i>
            One the best studios in the city. Expertly developed UNWIND workouts, guided by top industry professionals in a state-of-the-art facility.
            <i class="bx bxs-quote-alt-right quote-icon-right"></i>
          </p>
        </div>
        ...
        <div class="testimonial-item">
          ...
          <p>
            <i class="bx bxs-quote-alt-left quote-icon-left"></i>
            Results are amazing. Community feels really good. Classes and platforms are creative and constantly changing and evolving. The coaches really care about being there for us.
            <i class="bx bxs-quote-alt-right quote-icon-right"></i>
          </p>
        </div>
        ...
        <div class="testimonial-item">
          ...
          <p>
            <i class="bx bxs-quote-alt-left quote-icon-left"></i>
            My experience with UNWIND has been and continues to be perfect. Convenience at its finest.
            <i class="bx bxs-quote-alt-right quote-icon-right"></i>
          </p>
        </div>
            ...
            <form action="" method="POST" class="php-email-form">
              <div class="form-row">
                <div class="col-md-6 form-group">
                  <input type="text" name="feedback_name" class="form-control" id="feedback_name" placeholder="Your Name" data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
                  <!--<div class="validate"></div>-->
                </div>
                <div class="col-md-6 form-group">
                  <input type="email" class="form-control" name="feedback_email" id="feedback_email" placeholder="Your Email" data-rule="email" data-msg="Please enter a valid email" />
                  <!--<div class="validate"></div>-->
                </div>
              </div>
              <div class="form-group">
                <input type="text" class="form-control" name="feedback_subject" id="feedback_subject" placeholder="Subject" data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject" />
                <!--<div class="validate"></div>-->
              </div>
              <div class="form-group">
                <textarea class="form-control" name="feedback_message" rows="5" id="feedback_message" data-rule="required" data-msg="Please write something for us" placeholder="Message"></textarea>
                <!--<div class="validate"></div>-->
              </div>
              <div class="mb-3">
